...
\UIC{$\B{0}$}
    \AXC{$1$}
        \AXC{$2$}
    \BIC{$1 \mathrel{\land} 2$}
        \AXC{$1 \mathrel{\land} 2 \longrightarrow 4$}
    \BIC{$4$}
\BIC{$\B{0} \mathrel{\land} 4$}
    \AXC{$\kern-4em\B{0} \mathrel{\land} 4 \longrightarrow \B{6}$}
\BIC{$\B{6}$}
    \AXC{$[\B{0}]$}
    \UIC{$\B{0}$}
        \AXC{$3$}
            ...
            \BIC{$1 \mathrel{\land} 2$}
                \AXC{$1 \mathrel{\land} 2 \longrightarrow 4$}
            \BIC{$4$}
        \BIC{$3 \mathrel{\land} 4$}
            \AXC{$\kern-3em 3 \mathrel{\land} 4 \longrightarrow 5$}
        \BIC{$5$}
    \BIC{$\B{0} \mathrel{\land} 5$}
        \AXC{$\kern-5em\B{0} \mathrel{\land} 5 \longrightarrow \B{7}$}
    \BIC{$\B{7}$}
\BIC{$\B{6} \mathrel{\land} \B{7}$}
    \AXC{$\kern-5em\B{6} \mathrel{\land} \B{7} \longrightarrow \bot$}
\BIC{$\bot$}
\end{prooftree}
...
1 & \have 4
\end{align*}
Finally, if we reorder the sequents and introduce $\hence$ wherever possible, we
obtain a direct proof:
